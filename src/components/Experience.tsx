  ...
  return (
    <>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-surface-container-lowest border border-outline-variant/30 p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                {/* Diploma Image with Modal Trigger */}
                <div className="w-full lg:w-2/5 shrink-0">
                  <div 
                    className="rounded-xl overflow-hidden border-4 border-surface-container-high shadow-md bg-white cursor-pointer group"
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors flex items-center justify-center">
                        <span className="material-symbols-outlined text-white opacity-0 group-hover:opacity-100 transition-opacity drop-shadow-md text-3xl">zoom_in</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      {isModalOpen && (
        ...
        >
          <div className="relative max-w-5xl w-full max-h-[90vh] flex flex-col items-center justify-center animate-in zoom-in-95 duration-200">
            {/* Close Button */}
            <button 
              className="absolute -top-12 right-0 md:-right-12 text-white hover:text-primary transition-colors bg-black/50 hover:bg-black/80 rounded-full w-10 h-10 flex items-center justify-center cursor-pointer shadow-lg"
              onClick={() => setIsModalOpen(false)}
